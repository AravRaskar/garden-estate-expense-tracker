    ...
    container.innerHTML = `
        <div class="page-enter">
            <div class="page-header">
                <h1><span class="header-icon">${icon('building')}</span> Buildings Overview</h1>
            </div>
...
export async function renderBuildingDetail(container, buildingName, year) {
    container.innerHTML = `
        <div class="page-enter">
            <button class="back-btn" data-navigate="/buildings">← Back to Buildings</button>
            <div class="page-header">
